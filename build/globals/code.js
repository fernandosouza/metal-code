...
(function () {
    ...
    function $tabs(opt_data, opt_ignored, opt_ijData) {
      ...
      if (opt_data.tabs_) {
        ...
        for (var tabIndex21 = 0; tabIndex21 < tabListLen21; tabIndex21++) {
          ...
          ie_open('button', null, null, 'class', 'code-tab' + (selected__soy11 ? ' selected' : ''), 'data-index', tabIndex21, 'type', 'button', 'data-onclick', opt_data.handleTabClick);
          var dyn0 = tabData21;
  ...
  var Code = function (_Component) {
    ...
    function Code() {
      ...
      return babelHelpers.possibleConstructorReturn(this, (Code.__proto__ || Object.getPrototypeOf(Code)).apply(this, arguments));
    }
  ...
  this['metalNamed']['Code'] = this['metalNamed']['Code'] || {};
  this['metalNamed']['Code']['Code'] = Code;
  this['metalNamed']['Code']['templates'] = templates;
  this['metal']['Code'] = templates;
  /* jshint ignore:end */
}).call(this);
'use strict';
...
(function () {
	...
	var Code = function (_Component) {
		...
		babelHelpers.createClass(Code, [{
			...
			key: 'initTabs',
			value: function initTabs(container) {
				var _this2 = this;
				...
				setTimeout(function () {
					_this2.plotCode(_this2.tabContainers[0]);
				}, 100);
			}
		}, {
			key: 'plotCode',
			value: function plotCode(tabContent) {
			...
			key: 'syncContainer',
			value: function syncContainer(value) {
				this.tabContainers = value.querySelectorAll('.code');
				this.initTabs(value);
			}
		}, {
			key: 'syncTheme',
			value: function syncTheme(value) {
				CodeMirror.defaults.theme = value;
			}
		}, {
			key: 'toCodemirror',
			value: function toCodemirror(target) {
